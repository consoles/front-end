...
(function (window) {
    ...
    function View(root) {
        ...
        window.qs = function (selector, scope) {
            return _qs(selector, scope || root.document);
        };
        window.qsa = function (selector, scope) {
            return _qsa(selector, scope || root.document);
        };
        window.delegate = function (selector, event, handler) {
            return _delegate(selector, event, handler, root);
        };
        window.undelegate = function (selector, event, handler) {
            return _undelegate(selector, event, handler, root);
        };
