var RasterTests = function () {
    ...
    function register(mocha, expect) {
        ...
        describe("Raster Basics", function () {
            ...
            it("raster is a Raster", function () {
                expect(raster).to.be.an.instanceof(Raster);
            });
            it("raster set url", function () {
                expect(raster.url).to.equal("./resources/half-rectangle.png");
            });
            it("raster set shapeImageThreshold", function () {
                expect(raster.shapeImageThreshold).to.equal(0);
            });
            it("raster set shapeMargin", function () {
                expect(raster.shapeMargin).to.equal(0);
            });
            it("raster clip rectangle", function () {
                expect(raster.clip).not.null;
            });
            it("raster intervals is not null", function () {
                expect(raster.intervals).not.null;
            });
        });
        ...
        describe("Missing image", function () {
            ...
            it("intervals are undefined", function () {
                expect(image.intervals).to.be.undefined;
            });
            it("line equals image vertical extent", function () {
                checkExclusionEdges(image, 0, 100, 0, 100);
            });
        });
        ...
        describe("Image.left,rightExclusionEdge, (50x100px opaque, 50x100px transparent)", function () {
            describe("shape-margin=0", function () {
                ...
                it("line equals image vertical extent", function () {
                    checkExclusionEdges(image, 0, 100, 0, 50);
                });
                it("line overlaps image vertical extent, above", function () {
                    checkExclusionEdges(image, -100, 50, 0, 50);
                });
                it("line overlaps image vertical extent, below", function () {
                    checkExclusionEdges(image, 50, 150, 0, 50);
                });
                it("line contains image vertical extent", function () {
                    checkExclusionEdges(image, -100, 200, 0, 50)
                });
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, 0, 50)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, 0, 50)
                });
                it("line is above the image", function () {
                    checkExclusionEdges(image, -50, -30, undefined, undefined)
                });
                it("line is below the image", function () {
                    checkExclusionEdges(image, 101, 109, undefined, undefined)
                });
            });
            ...
            describe("shape-margin=10", function () {
                ...
                it("line equals image vertical extent", function () {
                    checkExclusionEdges(image, 0, 100, -10, 60);
                });
                it("line equals image + shape-margin vertical extent", function () {
                    checkExclusionEdges(image, -10, 110, -10, 60);
                });
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, -10, 60)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, -10, 60)
                });
            });
        });
        ...
        describe("Image.left,rightExclusionEdge, (50x100px opaque, 50x100px 20% opacity)", function () {
            describe("shape-margin=0; shape-image-threshold=0.19 (no wrapping)", function () {
                ...
                it("line overlaps image vertical extent, above", function () {
                    checkExclusionEdges(image, -100, 50, 0, 100);
                });
                it("line overlaps image vertical extent, below", function () {
                    checkExclusionEdges(image, 50, 150, 0, 100);
                });
                it("line contains image vertical extent", function () {
                    checkExclusionEdges(image, -100, 200, 0, 100)
                });
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, 0, 100)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, 0, 100)
                });
                it("line is above the image", function () {
                    checkExclusionEdges(image, -50, -30, undefined, undefined)
                });
            ...
            describe("shape-margin=10; shape-image-threshold=0.19 (no wrapping)", function () {
                ...
                it("line equals image vertical extent", function () {
                    checkExclusionEdges(image, 0, 100, -10, 110);
                });
                it("line equals image + shape-margin vertical extent", function () {
                    checkExclusionEdges(image, -10, 110, -10, 110);
                });
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, -10, 110)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, -10, 110)
                });
            });
        });
        ...
        describe("Image.left,rightExclusionEdge, left-base triangle", function () {
            describe("shape-margin=0", function () {
                ...
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, 0, 52)
                });
                it("line overlaps image's middle part", function () {
                    checkExclusionEdges(image, 40, 60, 0, 100)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 74, 100, 0, 52)
                });
            });
            ...
            describe("shape-margin=10", function () {
                ...
                it("line overlaps image's top part", function () {
                    checkExclusionEdgesWithRound(image, 0, 25, -10, 74)
                });
                it("line overlaps image's middle part", function () {
                    checkExclusionEdges(image, 40, 60, -10, 110)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdgesWithRound(image, 75, 100, -10, 72)
                });
            });
        });
        ...
        describe("Image.left,rightExclusionEdge, top-base triangle", function () {
            describe("shape-margin=0", function () {
                ...
                it("line overlaps image vertical extent, below", function () {
                    checkExclusionEdges(image, 50, 150, 25, 75);
                });
                it("line contains image vertical extent", function () {
                    checkExclusionEdges(image, -100, 200, 0, 100)
                });
                ...
                it("line overlaps image's middle part", function () {
                    checkExclusionEdges(image, 40, 60, 20, 80)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, 37, 63)
                });
            });
            ...
            describe("shape-margin=10", function () {
                ...
                it("line overlaps image's middle part", function () {
                    checkExclusionEdgesWithRound(image, 40, 60, 8, 92)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdgesWithRound(image, 75, 100, 26, 74)
                });
            });
        });
        ...
        describe("Image.left,rightExclusionEdge, right-base triangle", function () {
            describe("shape-margin=0", function () {
                ...
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, 48, 100)
                });
                it("line overlaps image's middle part", function () {
                    checkExclusionEdges(image, 40, 60, 0, 100)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, 50, 100)
                });
            });
            ...
            describe("shape-margin=10", function () {
                ...
                it("line overlaps image's top part", function () {
                    checkExclusionEdgesWithRound(image, 0, 25, 26, 110)
                });
                it("line overlaps image's middle part", function () {
                    checkExclusionEdges(image, 40, 60, -10, 110)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdgesWithRound(image, 75, 100, 28, 110)
                });
            });
        });
        ...
        describe("Image.left,rightExclusionEdge, bottom-base triangle", function () {
            describe("shape-margin=0", function () {
                ...
                it("line overlaps image vertical extent, above", function () {
                    checkExclusionEdges(image, -100, 50, 24, 76);
                });
                it("line overlaps image vertical extent, below", function () {
                    checkExclusionEdges(image, 50, 150, 0, 100);
                });
                ...
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, 37, 63)
                });
                it("line overlaps image's middle part", function () {
                    checkExclusionEdges(image, 40, 60, 19, 81)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, 0, 100)
                });
            ...
            describe("shape-margin=10", function () {
                ...
                it("line overlaps image's top part", function () {
                    checkExclusionEdgesWithRound(image, 0, 25, 25, 75)
                });
                it("line overlaps image's middle part", function () {
                    checkExclusionEdgesWithRound(image, 40, 60, 8, 92)
                });
        ...
        describe("Image.left,rightExclusionEdge, top-left triangle", function () {
            describe("shape-margin=0", function () {
                ...
                it("line overlaps image's middle part", function () {
                    checkExclusionEdges(image, 40, 60, 0, 60)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, 0, 25)
                });
            });
            ...
            describe("shape-margin=10", function () {
                ...
                it("line overlaps image's top part", function () {
                    checkExclusionEdgesWithRound(image, 0, 25, -10, 110)
                });
                it("line overlaps image's middle part", function () {
                    checkExclusionEdgesWithRound(image, 40, 60, -10, 74)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdgesWithRound(image, 75, 100, -10, 39)
                });
            });
        });
        ...
        describe("Image.left,rightExclusionEdge, top-right triangle", function () {
            describe("shape-margin=0", function () {
                ...
                it("line overlaps image vertical extent, below", function () {
                    checkExclusionEdges(image, 50, 150, 50, 100);
                });
                it("line contains image vertical extent", function () {
                    checkExclusionEdges(image, -100, 200, 0, 100)
                });
                ...
                it("line overlaps image's middle part", function () {
                    checkExclusionEdges(image, 40, 60, 40, 100)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, 75, 100)
                });
            });
            ...
            describe("shape-margin=10", function () {
                ...
                it("line overlaps image's middle part", function () {
                    checkExclusionEdgesWithRound(image, 40, 60, 26, 110)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdgesWithRound(image, 75, 100, 61, 110)
                });
            });
        });
        ...
        describe("Image.left,rightExclusionEdge, bottom-right triangle", function () {
            describe("shape-margin=0", function () {
                ...
                it("line overlaps image vertical extent, above", function () {
                    checkExclusionEdges(image, -100, 50, 49, 100);
                });
                it("line overlaps image vertical extent, below", function () {
                    checkExclusionEdges(image, 50, 150, 0, 100);
                });
                ...
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, 74, 100)
                });
                it("line overlaps image's middle part", function () {
                    checkExclusionEdges(image, 40, 60, 39, 100)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, 0, 100)
                });
            ...
            describe("shape-margin=10", function (done) {
                ...
                it("line overlaps image's top part", function () {
                    checkExclusionEdgesWithRound(image, 0, 25, 60, 110)
                });
                it("line overlaps image's middle part", function () {
                    checkExclusionEdgesWithRound(image, 40, 60, 25, 110)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdgesWithRound(image, 75, 100, -10, 110)
                });
            });
        });
        ...
        describe("Image.left,rightExclusionEdge, bottom-left triangle", function () {
            describe("shape-margin=0", function () {
                ...
                it("line overlaps image vertical extent, above", function () {
                    checkExclusionEdges(image, -100, 50, 0, 51);
                });
                it("line overlaps image vertical extent, below", function () {
                    checkExclusionEdges(image, 50, 150, 0, 100);
                });
                ...
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, 0, 26)
                });
                it("line overlaps image's middle part", function () {
                    checkExclusionEdges(image, 40, 60, 0, 61)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, 0, 100)
                });
            ...
            describe("shape-margin=10", function () {
                ...
                it("line overlaps image's top part", function () {
                    checkExclusionEdgesWithRound(image, 0, 25, -10, 40)
                });
                it("line overlaps image's middle part", function () {
                    checkExclusionEdgesWithRound(image, 40, 60, -10, 75)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, -10, 110)
                });
        ...
        describe("Image.left,rightExclusionEdge, assimetric star", function () {
            describe("shape-margin=0", function () {
                ...
                it("line overlaps image vertical extent, below", function () {
                    checkExclusionEdges(image, 50, 150, 13, 87);
                });
                it("line contains image vertical extent", function () {
                    checkExclusionEdges(image, -100, 200, 0, 100)
                });
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, 35, 65)
                });
                it("line overlaps image's middle part", function () {
                    checkExclusionEdges(image, 30, 60, 0, 100)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, 32, 68)
                });
            });
            ...
            describe("shape-margin=10", function () {
                ...
                it("line overlaps image's top part", function () {
                    checkExclusionEdgesWithRound(image, 0, 25, 24, 76)
                });
                it("line overlaps image's middle part", function () {
                    checkExclusionEdgesWithRound(image, 30, 60, -10, 110)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 75, 100, 22, 78)
                });
            });
        });
        ...
        describe("Image.left,rightExclusionEdge, (50x100px opaque, 50x100px transparent) at 0.5 scale", function () {
            describe("shape-margin=0", function () {
                ...
                it("line equals image vertical extent", function () {
                    checkExclusionEdges(image, 0, 50, 0, 25);
                });
                it("line overlaps image vertical extent, above", function () {
                    checkExclusionEdges(image, -25, 25, 0, 25);
                });
                it("line overlaps image vertical extent, below", function () {
                    checkExclusionEdges(image, 25, 75, 0, 25);
                });
                it("line contains image vertical extent", function () {
                    checkExclusionEdges(image, -25, 75, 0, 25)
                });
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, 0, 25)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 25, 50, 0, 25)
                });
                it("line is above the image", function () {
                    checkExclusionEdges(image, -50, -25, undefined, undefined)
                });
                it("line is below the image", function () {
                    checkExclusionEdges(image, 75, 100, undefined, undefined)
                });
            });
            ...
            describe("shape-margin=10", function () {
                ...
                it("line equals image vertical extent", function () {
                    checkExclusionEdges(image, 0, 50, -10, 35);
                });
                it("line equals image + shape-margin vertical extent", function () {
                    checkExclusionEdges(image, -10, 75, -10, 35);
                });
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, -10, 35)
                });
                it("line overlaps image's bottom part", function () {
                    checkExclusionEdges(image, 25, 50, -10, 35)
                });
            });
        });
        ...
        describe("Image.left,rightExclusionEdge, (50x100px opaque, 50x100px transparent) at 2.0 scale", function () {
            ...
            describe("shape-margin=0", function () {
                ...
                it("line equals image vertical extent", function () {
                    checkExclusionEdges(image, 0, 200, 0, 100);
                });
                it("line overlaps image vertical extent, above", function () {
                    checkExclusionEdges(image, -25, 25, 0, 100);
                });
                it("line overlaps image vertical extent, below", function () {
                    checkExclusionEdges(image, 175, 225, undefined, undefined);
                });
                it("line contains image vertical extent", function () {
                    checkExclusionEdges(image, -25, 225, 0, 100)
                });
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, 0, 100)
                });
                ...
                it("line is below the image", function () {
                    checkExclusionEdges(image, 225, 250, undefined, undefined)
                });
            });
            ...
            describe("shape-margin=10", function () {
                ...
                it("line equals image vertical extent", function () {
                    checkExclusionEdges(image, 0, 200, -10, 110);
                });
                it("line equals image + shape-margin vertical extent", function () {
                    checkExclusionEdges(image, -10, 225, -10, 110);
                });
                it("line overlaps image's top part", function () {
                    checkExclusionEdges(image, 0, 25, -10, 110)
                });
