...
function getCanvas() {
    return document.getElementById("polygon-editor-canvas");
}
...
function pointIsNearLine(p) {   // Return null, "line", "lineTop", or "lineBottom"
    ...
    function isCloseTo(y, threshold) {
        return y >= 0 && y <= threshold;
    }
...
function compareVertexYIncreasing(vertex1, vertex2) {
    return vertex2.y - vertex1.y;
}
