...
define(['Editor', 'CSSUtils', 'snap', 'lodash'], function (Editor, CSSUtils, Snap, _) {
    ...
    EllipseEditor.prototype.getCSSValue = function (unit) {
        ...
        cx = CSSUtils.convertFromPixels(cx, unit || this.coords.cxUnit, this.target, {
            isHeightRelated: false,
            boxType: refBox
        });
        cy = CSSUtils.convertFromPixels(cy, unit || this.coords.cyUnit, this.target, {
            isHeightRelated: true,
            boxType: refBox
        });
        rx = CSSUtils.convertFromPixels(rx, unit || this.coords.rxUnit, this.target, {
            isHeightRelated: false,
            boxType: refBox
        });
        ry = CSSUtils.convertFromPixels(ry, unit || this.coords.ryUnit, this.target, {
            isHeightRelated: true,
            boxType: refBox
        });
